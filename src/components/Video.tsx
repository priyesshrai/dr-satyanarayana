            ...
            <Wrapper>
                <div className='relative w-full flex flex-col lg:gap-14 md:gap-10 gap-8'>
                    <div className='flex-1 text-center'>
                        <Heading>
                            My Procedural Videos
                        </Heading>
                        <Subheading className='mx-auto max-w-md'>
                            Demonstrating essential healthcare techniques through easy-to-follow procedural videos.
                        </Subheading>
                    </div>
        ...
        <AnimatePresence>
            {open && (
                <>
                    ...
                    <motion.div
                        className="fixed bottom-0 left-0 right-0 bg-dark-navy rounded-t-3xl shadow-2xl z-50 overflow-y-auto h-[550px]"
                        initial={{ y: "100%" }}
                        animate={{ y: "8%" }}
                        exit={{ y: "100%" }}
                        transition={{
