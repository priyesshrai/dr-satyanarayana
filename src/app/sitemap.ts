...
export default function sitemap(): MetadataRoute.Sitemap {
  const pages = [
    ...
    { url: 'https://www.drsatyanarayanagarre.in/terms-of-service.html', priority: 0.8 },
    { url: 'https://www.drsatyanarayanagarre.in/privacy-policy.html', priority: 0.8 },
    { url: 'https://www.drsatyanarayanagarre.in/cancellation-and-refund-policy.html', priority: 0.8 },
